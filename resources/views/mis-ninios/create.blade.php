...
@section('breadcrumbs')
{{ Breadcrumbs::render('mis-ninios.create') }}
@endsection



@section('content')
<form action="{{ route('mis-ninios.store') }}" method="POST" id="formUser" autocomplete="off">
    @csrf
    <div class="card">
        ...
        <div class="card-body row">
            ...
            <div class="col-md-6 mb-1">
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <input name="numero_child" value="{{ old('numero_child') }}" type="number" class="form-control @error('numero_child') is-invalid @enderror" required autofocus >
            ...
            <div class="col-md-6 mb-1">
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <input name="nombres_completos" value="{{ old('nombres_completos') }}" type="text" class="form-control @error('nombres_completos') is-invalid @enderror" required >
            ...
            <div class="col-md-6 mb-1">
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <select class="form-select @error('genero') is-invalid @enderror" name="genero" required>
                        <option value=""></option>
                        <option value="Male" {{ old('genero')=='Male'?'selected':'' }}>Male</option>
                        <option value="Female" {{ old('genero')=='Female'?'selected':'' }}>Female</option>
                    </select>
                ...
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <select name="comunidad" class="form-select @error('comunidad') is-invalid @enderror" required>
                        ...
                        @foreach ($comunidades as $comunidad)
                            <option value="{{ $comunidad->id }}" {{ old('comunidad')==$comunidad->id?'selected':'' }}>{{ $comunidad->nombre }}</option>
                        @endforeach
            ...
            <div class="col-md-6 mb-1">
                <div class="form-floating form-control-feedback form-control-feedback-start">
                    ...
                    <input name="numero_celular" value="{{ old('numero_celular') }}" type="text" class="form-control @error('numero_celular') is-invalid @enderror" >
