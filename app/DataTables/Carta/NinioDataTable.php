...
namespace App\DataTables\Carta;
...
class NinioDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($n){
            return view('cartas.ninio-action',['n'=>$n])->render();
        })
    ...
    public function query(Ninio $model): QueryBuilder
    {
        ...
        if($user->hasRole('ADMINISTRADOR')){
            ...
            $comunidadesIds=$user->comunidades->pluck('id');
            return $model->whereIn('comunidad_id',$comunidadesIds);
        }
